...
folder = fileparts(which('C:\Users\HP\Desktop\Spain\MIRA\PRoject\Project'));   % Get current folder
addpath(genpath(folder));               % Add all subfolders to path

% Indexes of folders
folder_index = {'copd1'; 'copd2'; 'copd3'; 'copd4'; 'copd7'; 'copd8'; 'copd9'; 'copd10'};
...
folder = strcat('train\',folder_index{index}, '\');
