function [dice_coef] = MNIEMLabelPropSeg(test_mask, test_image, test_label, CSF_atlas_mni, WM_atlas_mni, GM_atlas_mni)
T1_nii = test_image;
...
CSF_atlas_vector = CSF_atlas_mni;
WM_atlas_vector = WM_atlas_mni;
GM_atlas_vector = GM_atlas_mni;
